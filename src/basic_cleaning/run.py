...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "Name of the input raw data file",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "Name of the input cleaned data file",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "The min allowed value in USD (floor)",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "The max allowed value in USD (ceiling)",
        required = True
    )
